...
from windmi_pub.cases import run_case_3
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        default=str(Path("outputs") / "case_3_variable_rolling_ic"),
        help="Output folder. Default: outputs/case_3_variable_rolling_ic",
    )
    parser.add_argument(
        "--data-root",
        default=None,

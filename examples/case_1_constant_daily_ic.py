...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run WINDMI case 1: constant L, C, Sigma with daily I_c.")
    ...
    parser.add_argument(
        "--output-dir",
        default=str(Path("outputs") / "case_1_constant_daily_ic"),
        help="Output folder. Default: outputs/case_1_constant_daily_ic",
    )
    parser.add_argument(
        "--data-root",
        default=None,
